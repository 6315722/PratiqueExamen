...
namespace JardinBotanique.ContenuJardin
{
    public class Plante
    {
        ...
        /// <summary>
        /// Quantité d'eau dont la plante a besoin à l'arrosage.
        /// </summary>
        ...
        public Plante(string nom, TypePlante typePlante, int besoinEau, int frequenceEngrais)
        {
            Nom = nom;
            Type = typePlante;
            ...
            // Selon le type de la plante, retourner une valeur représentant la toléance en Eau.
            ToleranceSansEau = typePlante switch
            {
        ...
        /// </summary>
        /// <param name="ressources">Les ressources disponibles</param>
        /// <param name="date">La date de l'entretien</param>
